...
async function update(req, res) {
    ...
    const photoPrefix = 'https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/'
    ...
    for (const cat of categories) {
        ...
        for (const [idx, sub] of subCategories.entries()) {
            ...
            const courses = data[idx].data.CatalogResultsV2Resource
                .browseV2.elements[0].courses.elements
                .filter(course => course.photoUrl.includes(photoPrefix))
